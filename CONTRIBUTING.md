...
* Fork the EyeTrackVR Repository [git repository](https://github.com/EyeTrackVR/EyeTrackVR).
* Write/Change the code in your Fork for a new feature, bug fix, new sensor, optimization, etc.
* Ensure tests work.
* Create a Pull Request against the [**development**](https://github.com/EyeTrackVR/EyeTrackVR/tree/dev) branch of EyeTrackVR.
